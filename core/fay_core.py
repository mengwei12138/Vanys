    ...
    def __say(self, styleType):
        try:
            if len(self.a_msg) < 1:
                ...
                util.printInfo(1, 'vanys', '({}) {}'.format(self.__get_mood(), self.a_msg))
